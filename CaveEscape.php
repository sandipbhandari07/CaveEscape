...
function display_intro_instructions () {
   ...
   ctx.fillText("Press up or down arrow to start",myCanvas.width / 1.35, 320); 
   var score = 0;                                                       
   ctx.font= "30px 'Reggae One', cursive";
   ctx.fillStyle= "white";
   ctx.textAlign="center";
   ctx.fillText("Level 1 " , myCanvas.width / 4.50, 530);  
   ctx.font= "20px 'Reggae One', cursive";
   }
   function showscorewhileplaying(){
               ...
               ctx.fillStyle= "white";
               ctx.textAlign="center";
               ctx.fillText("Level 1 " , myCanvas.width / 4.50, 390);
                }
